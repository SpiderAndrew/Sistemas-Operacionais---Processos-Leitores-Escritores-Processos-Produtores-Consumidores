...
#include <time.h>
            ...
            //VERSÃO SEM CONTROLE DE ACESSO (SEM SEMÁFOROS E MUTEX) - PARA TESTE E COMPARAÇÃO

#define TAM_BUFFER 5 // Tamanho do buffer compartilhado 
...
sleep(1); // Simula o tempo para digitar a mensagem
...
printf("[PROCESSADOR %d] ENTROU na regiao critica\n",
       ...
       sleep(1); // Simula o tempo para processar a mensagem
